...
<head>
    ...
    <style>
        /* 2. CSS CUSTOM (Hanya untuk Warna) */
        body { 
            background: #6B9A2D; /* Warna Hijau Kamu */
        }
        .bg-boyaen { 
            background: #4A2B0F !important; /* Warna Cokelat Kamu */
            color: white !important;
        }
        .text-boyaen { 
            color: #4A2B0F !important; 
        }
        /* CSS lama yang width:350px, display:flex, dll SEMUANYA DIHAPUS */
    </style>
</head>
